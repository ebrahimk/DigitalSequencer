...
static const uint8_t colorpins[4][3] = {{13,12,11}, {10,9,8},{7,6,5},{36,37,38}};
...
static void scan()
{
  ...
  uint8_t i, j;
    ...
    for(i = 0; i < NUM_LED_ROWS; i++)
    {
        ...
        if(val)
        {
            analogWrite(colorpins[0][0], 0);
            analogWrite(colorpins[0][1], 139);
            analogWrite(colorpins[0][2], 139);
        }
  }
